...
public class MyConfig {
    ...
    public OAuth2AuthorizedClientManager manager(
        ...
        DefaultOAuth2AuthorizedClientManager defaultOAuth2AuthorizedClientManager = new DefaultOAuth2AuthorizedClientManager(clientRegistrationRepositor, auth2AuthorizedClientRepository);
